    ...
    extend: {
      colors: {
        ...
        workflow: {
          ...
          "trigger-foreground": "hsl(var(--workflow-trigger-foreground))",
          action: "hsl(var(--workflow-action))",
          "action-foreground": "hsl(var(--workflow-action-foreground))",
          condition: "hsl(var(--workflow-condition))",
          "condition-foreground": "hsl(var(--workflow-condition-foreground))",
          delay: "hsl(var(--workflow-delay))",
          "delay-foreground": "hsl(var(--workflow-delay-foreground))",
